...
public class NamespaceDeclLista extends NamespaceDeclList {

    private NamespaceDeclList NamespaceDeclList;
    private NamespaceDecl NamespaceDecl;

    public NamespaceDeclLista (NamespaceDeclList NamespaceDeclList, NamespaceDecl NamespaceDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NamespaceDeclLista(\n");
