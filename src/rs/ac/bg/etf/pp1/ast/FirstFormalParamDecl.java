...
public class FirstFormalParamDecl extends FormalParamsList {

    private SingleFormalParamDecl SingleFormalParamDecl;

    public FirstFormalParamDecl (SingleFormalParamDecl SingleFormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FirstFormalParamDecl(\n");
