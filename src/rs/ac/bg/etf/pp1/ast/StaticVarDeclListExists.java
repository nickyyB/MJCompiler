...
public class StaticVarDeclListExists extends StaticVarDeclList {

    private StaticVarDeclList StaticVarDeclList;
    private VarDecl VarDecl;

    public StaticVarDeclListExists (StaticVarDeclList StaticVarDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StaticVarDeclListExists(\n");
