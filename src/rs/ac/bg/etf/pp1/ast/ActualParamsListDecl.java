...
public class ActualParamsListDecl extends ActualParamsList {

    private ActualParamsList ActualParamsList;
    private Expr Expr;

    public ActualParamsListDecl (ActualParamsList ActualParamsList, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ActualParamsListDecl(\n");
